  ...
  return (
    <div data-testid='Cart' className='Cart'>
      ...
      <form>
        ...
        <div>Street1: <input type="text" onChange={e => setStreet1(e.target.value)} value={street1} /></div>
        <div>Street2: <input type="text" onChange={e => setStreet2(e.target.value)} value={street2} /></div>
        <div>City: <input type="text" onChange={e => setCity(e.target.value)} value={city} /></div>
        <div>State: <input type="text" onChange={e => setState(e.target.value)} value={state} /></div>
        <div>Zipcode: <input type="text" onChange={e => setZipcode(e.target.value)} value={zipcode} /></div>
      </form>
